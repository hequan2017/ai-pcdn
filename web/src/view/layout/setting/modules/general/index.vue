<!-- Modified for ai-pcdn on 2026-07-21: 已获商业授权，统一为 ai-pcdn 产品信息。 -->
<template>
          ...
          <div class="flex items-start gap-5">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm gva-theme-text-sub mb-5 leading-relaxed">
                基于 Vue 3、Gin 与 SQLite 构建的 PCDN 管理平台
              </p>
              <p class="text-sm font-medium" :style="{ color: settings.themeColor }">
                ai-pcdn
              </p>
            </div>
          </div>
